...
BB_ENV_PASSTHROUGH_ADDITIONS="PUT $BB_ENV_PASSTHROUGH_ADDITIONS" PUT="aws-iot-device-sdk-cpp-v2-samples-fleet-provisoning-ptest" bitbake core-image-minimal
