...
ERROR: add credentials here:
    echo [default] > ${D}/home/root/.aws/credentials
    echo "aws_access_key_id = " >> ${D}/home/root/.aws/credentials
    echo "aws_secret_access_key = " >> ${D}/home/root/.aws/credentials
    echo "region = " >> ${D}/home/root/.aws/credentials
}

FILES:${PN}-ptest += "/home/root/.aws/credentials"